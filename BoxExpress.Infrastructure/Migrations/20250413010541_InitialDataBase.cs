        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClientAddress_Cities_CityId",
                        column: x => x.CityId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShopifyVariantId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecondManagement = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_ClientAddress_ClientAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderCategoryHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderCategoryHistories_OrderCategories_NewCategoryId",
                        column: x => x.NewCategoryId,
                        principalTable: "OrderCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderCategoryHistories_OrderCategories_OldCategoryId",
                        column: x => x.OldCategoryId,
                        principalTable: "OrderCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderCategoryHistories_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderCategoryHistories_NewCategoryId",
                table: "OrderCategoryHistories",
                column: "NewCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderCategoryHistories_OldCategoryId",
                table: "OrderCategoryHistories",
                column: "OldCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderCategoryHistories_OrderId",
                table: "OrderCategoryHistories",
                column: "OrderId");
