...
namespace BoxExpress.Infrastructure.Migrations
{
    ...
    [Migration("20251010004017_RemoveRequiredCategoryHistory")]
    partial class RemoveRequiredCategoryHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoxExpress.Domain.Entities.DeliveryProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoxExpress.Domain.Entities.ProductLoan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoxExpress.Domain.Entities.ProductLoanDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductLoanId");

                    b.HasIndex("ProductVariantId");

                    b.ToTable("ProductLoanDetails");
                });
            ...
            modelBuilder.Entity("BoxExpress.Domain.Entities.OrderStatusHistory", b =>
                {
                    ...
                    b.HasOne("BoxExpress.Domain.Entities.DeliveryProvider", "DeliveryProvider")
                        .WithMany()
            ...
            modelBuilder.Entity("BoxExpress.Domain.Entities.ProductLoan", b =>
                {
                    b.HasOne("BoxExpress.Domain.Entities.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BoxExpress.Domain.Entities.User", "ProcessedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("BoxExpress.Domain.Entities.ProductLoanDetail", b =>
                {
                    b.HasOne("BoxExpress.Domain.Entities.ProductLoan", "ProductLoan")
                        .WithMany("Details")
                        .HasForeignKey("ProductLoanId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
